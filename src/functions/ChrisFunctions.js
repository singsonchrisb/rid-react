...
export function myChrichFormat(value,tType) {
  if (tType.toLowerCase() ==='number') {
      return new Intl.NumberFormat().format(value);
  } else if (tType.toLowerCase() ==='peso') {
      return new Intl.NumberFormat('en-PH', { style: 'currency', currency: 'PHP' }).format(value);
  } else if (tType.toLowerCase() ==='amount') {    
...
export function appVersion() {
  ...
  let retVal ='v.1.4 2024-07-29 10:15pm';
  return retVal;
};
