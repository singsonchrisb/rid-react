...
import { Container, TextField, Button, Grid, Typography, Box, MenuItem, Select, InputLabel, FormControl, Avatar, Card,CardMedia, useTheme,useMediaQuery } from '@mui/material';
...
import imgUser from '../../../images/blank-profile-picture.png'
...
const RIDClearanceForm = () => {
  ...
  return (
    ...
    <Container maxWidth="md">
      {/* {isMobile ?
        <>
        <Box align='center' display="block" justifyContent="space-between" alignItems="center" mb={2}>
          <Box >
            <Typography variant="h4" align='center'>R I D Clearance</Typography>
            <Typography variant="h4" align='center' gutterBottom>Application Form</Typography>
              <Box border={1} borderRadius={2} borderColor="lightgray" sx={{ width:'160px',heighte:'160px', padding:'5px 5px 5px 5px' }}>
                <Card >
                    <CardMedia
                      component="img"
                      height="140"
      ...
      :
        <> */}
        <Box align='center' display={isMobile ? "block":"flex"} justifyContent="space-between" alignItems="center" mb={2}>
                ...
                <Box border={1} borderRadius={2} borderColor="lightgray" sx={{ width:'160px',heighte:'160px', padding:'5px 5px 5px 5px' }}>
                  <Card >
                      <CardMedia
                        ...
                        width="140"
                        image={imageShow}
                        alt="2x2" // Replace with appropriate alt text
                        sx={{ border: 'none' }}
                      />
                  </Card>     
                </Box>  
        ...
        <Box mt={3} align='center'>
            <Button style ={{width:'90%', fontSize:'16px', textTransform:'none'}} type="button" variant="contained" color="success" onClick={() => handleSave()}>Save</Button>
